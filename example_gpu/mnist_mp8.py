...
tf.flags.DEFINE_integer("train_epochs", 4, "Total number of training epochs.")
...
# this is for model parallel
#tf.flags.DEFINE_string("mesh_shape", "b1:4;b2:2", "mesh shape")
#tf.flags.DEFINE_string("layout", "row_blocks:b1;col_blocks:b2", "layout rules")
# this is data parallel
tf.flags.DEFINE_string("mesh_shape", "b1:2;b2:2;b3:2", "mesh shape")
tf.flags.DEFINE_string("layout", "row_blocks:b1;col_blocks:b2;filters1:b3", "layout rules")
...
def model_fn(features, labels, mode, params):
  ...
  # ssy change to use 4 gpu, this can also work with default command line
  #mesh_devices = ["gpu:0", "gpu:1", "gpu:2", "gpu:3"]
  # this CAN NOT work with default command line, you need 4*2 like dim
  mesh_devices = ["gpu:0","gpu:1","gpu:2", "gpu:3","gpu:4","gpu:5","gpu:6", "gpu:7"]

  print("mesh_shape : "+str(mesh_shape))
  print("layout_rules : "+str(layout_rules))
  print("mesh_size : "+str(mesh_size))
  print("mesh_devices : "+str(mesh_devices))

  mesh_impl = mtf.placement_mesh_impl.PlacementMeshImpl(
      mesh_shape, layout_rules, mesh_devices)
  print("mesh_impl : "+str(mesh_impl))
